...
u16  Rise[7],Drop[7];  						
//遥控器输入数据暂存处【2015年8月14日13:30:46】
u16  RC_Pwm_In[8] = {	// ROLL横滚角 【CH1】左右移动
						//1500 1300[向左]
						1500,\
						//PTICH俯仰角 【CH2】前后移动
						//大于1520方向往后（1620向后）；<1520向前(1420向前)
						1500,\
						//THR油门	  【CH3】
						1520,\
						//YAW航向角	  【CH4】调旋转
...
//          Rise[0]=TIM_GetCapture1(TIM2); //定时器2通道1捕获（ROLL横滚角）数据存入Rise[0]中
//      }
//			else 
//			{
